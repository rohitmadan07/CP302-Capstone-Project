...
class BLOCK {
  public:
    ...
    BLOCK() {
        ...
        //Nupur, Antara
        counter = 0;
        if_checked = 0; //to ensure that one block is only counted once for cache pollution calc.
    };
};
...
class PACKET {
  public:
    ...
    uint64_t address, 
             ...
             event_cycle,
             cycle_enqueued,
             In_time,  //Nupur, Antara - time of insert in RQ
             Is_Late,
             late_cycle_counter;  //saurabh
	...
	fill_l1d = 0;
        ...
        cycle_enqueued = 0;
        In_time = 0; //Nupur, Antara
        Is_Late =0;
        late_cycle_counter = 0;  //saurabh
    };
};
